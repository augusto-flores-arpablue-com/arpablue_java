 ...
 */
public class TreePath extends TreePathPrinter {
     ...
     */
    protected void convertFromArrayString(String target, TreePath tree){
        if( target == null ){
            return;
        }
     ...
     */
    protected void convertFromString(String target, TreePath tree){
        if( target == null ){
            return;
        }
        if( mStrPos >= target.length() - 1 ){
